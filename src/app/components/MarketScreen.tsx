...
import {
  ArrowLeft, Filter, Search, X, ChevronRight, Zap,
...
export const MarketScreen = ({ onBack, onNavigateToCurrencies, onNavigateToSignal }: { onBack: () => void; onNavigateToCurrencies: () => void; onNavigateToSignal?: () => void }) => {
          ...
          <div className="flex items-center gap-1">
            ...
            {onNavigateToSignal && (
              <button
                ...
                className="flex items-center gap-1.5 bg-amber-500 hover:bg-amber-400 transition px-3 py-2 rounded-full"
                title="BullsSignal"
              >
                <Zap className="w-3.5 h-3.5 text-white" />
                <span className="text-white text-xs font-bold">Signal</span>
              </button>
            )}
          </div>
        </div>
